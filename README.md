...
- `notebooks/02_grid_isochrones.ipynb`: land and urban-activity 500 m grid, four-mode 15-minute accessibility, spatial joins, and cached grid output.
...
- `data/processed/shanghai_500m_health_grid.parquet`: 25,260 land/activity 500 m grid cells.
- `data/output/shanghai_health_h3_r8.geojson`: full H3 analysis layer, 12,176 H3 cells at resolution 8.
